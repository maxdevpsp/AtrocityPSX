...
static const char *funny_messages[][2] = {
	...
	{"ITS NOT A MISTAKE", "nvm yes it is"},
	{"JELLYBEAN VS", "VS SANS UNDERTALE"},
	{"ITS NOT A MISTAKE", "ITS A MASTERPIECE"},
	{"WERE FUNNIER THAN YOU", "THATS FOR SURE"},
	{"READING MY AWFUL", "HATE COMMENTS"},
	{"OMG ITS JELLYBEAN FROM", "FROM FNF"},
};
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 2:
					case 1:
						menu.font_bold.draw(&menu.font_bold, "MAXDEV",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "FUNNY POTATO CAT",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "YEAH", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 8, FontAlign_Center);
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "PSX", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
						menu.font_bold.draw(&menu.font_bold, "ATROCITY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 24, FontAlign_Center);
						break;
				}
				break;
			}
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "WERE FUNNIER THAN YOU", {"ATROCITY", NULL, NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, 0xFF9271FD, "ATROCITY"},
			};
